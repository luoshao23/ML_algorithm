...
def conv_forward(A_prev, W, b, hparameters):
    ...
    for i in range(m):  # loop over the batch of training examples
        a_prev_pad = A_prev_pad[
            i]  # Select ith training example's padded activation
        for h in range(n_H):  # loop over vertical axis of the output volume
            for w in range(
                    n_W):  # loop over horizontal axis of the output volume
                for c in range(
                        n_C
...
def pool_forward(A_prev, hparameters, mode="max"):
    ...
    for i in range(m):  # loop over the training examples
        for h in range(n_H):  # loop on the vertical axis of the output volume
            for w in range(
                    n_W):  # loop on the horizontal axis of the output volume
                for c in range(
                        n_C):  # loop over the channels of the output volume
        ...
        for h in range(n_H):  # loop over vertical axis of the output volume
            for w in range(
                ...
                for c in range(
                    ...
                    da_prev_pad[vert_start:vert_end, horiz_start:
                                horiz_end, :] += W[:, :, :, c] * dZ[i, h, w, c]
